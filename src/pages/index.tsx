...
const links = [
  { url: '/01', title: 'Infinite tags', number: '01' },
  { url: '/02', title: "Antfu's plum", number: '02' },
  { url: '/03', title: 'DVD', number: '02' },
]
      ...
      <div className="page">
        <div className="index-page centered w-[500px]">
          ...
          <pre className="grid gap-y-1 gap-x-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {links.map(link => (
              <li className="text-gray-400  block mr-4 list-none hover:text-gray-700 duration-150 ease-in-out group/link">
                <Link to={link.url}>
